export function applyProperties() {
    ...
    CONFIG.DND5E.weaponMasteries.automatic = { label: "Automatic", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.sDVM8aeCyMJI3Y05"};
    CONFIG.DND5E.weaponMasteries.bludgeon = { label: "Bludgeon", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.PM28fzU2d3Idgyv1" };
    CONFIG.DND5E.weaponMasteries.explode = { label: "Explode", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.pwMqTfmrNcA2hA2P" };
    CONFIG.DND5E.weaponMasteries.mounted = {label: "Mounted", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.4vM1MUnjVlIbzPHZ"};
    CONFIG.DND5E.weaponMasteries.jolt = { label: "Jolt", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.77XPK38laRNIZNMM" };
    CONFIG.DND5E.weaponMasteries.sighted = { label: "Sighted", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.0BTMbCQilYVhSeQz" };
    CONFIG.DND5E.weaponMasteries.scatter = { label: "Scatter", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.JeWhZcR6EkEYiXTV" };
    CONFIG.DND5E.weaponMasteries.overheat = { label: "Overheat", reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.BJiuHTRaJiyxNhHK.JournalEntryPage.Vmqh5SsBHN5v71Kr" };

    CONFIG.DND5E.skills.data = {
        label: "Data",
        ability: "int",
        fullKey: "data", // Full key used in enrichers
        reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.V9i0nElFa0T8vwHw.JournalEntryPage.aHfBq8JMZ1J0zfkJ", // UUID of journal entry page for rich tooltips
    ...
    CONFIG.DND5E.skills.tech = {
        ...
        reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.V9i0nElFa0T8vwHw.JournalEntryPage.Lu7X02t1jGqp7pxK", // UUID of journal entry page for rich tooltips
        icon: "…" // Icon used in favorites on new character sheet
    };
    ...
    CONFIG.DND5E.skills.pilot = {
        ...
        reference: "Compendium.dms.rule-book-dark-matter.JournalEntry.V9i0nElFa0T8vwHw.JournalEntryPage.mXGH81bII95DgoOB", // UUID of journal entry page for rich tooltips
        icon: "…" // Icon used in favorites on new character sheet
    };
    ...
    CONFIG.DND5E.weaponIds.martialblaster = "Compendium.dms.items-dark-matter.Item.J7hcfLcMJtuuvQVH";
    ...
    CONFIG.DND5E.weaponIds.plasmalauncher = "Compendium.dms.items-dark-matter.Item.4sUkxsL4pozbOEqu";
    ...
    CONFIG.DND5E.weaponIds.singularityemitter = "Compendium.dms.items-dark-matter.Item.e0d9t7J3pHAUyjmY";
    ...
    CONFIG.DND5E.weaponIds.ballisticgloves = "Compendium.dms.items-dark-matter.Item.xpN982HXYpOYptol";
    ...
    CONFIG.DND5E.weaponIds.laserhalfsword = "Compendium.dms.items-dark-matter.Item.qqloXunQBIScskya";
    ...
    CONFIG.DND5E.weaponIds.repulsorgauntlet = "Compendium.dms.items-dark-matter.Item.YVi3pxuyfqZoO6ZY";
    ...
    CONFIG.DND5E.tools.circuitkit = {ability: "int", id:"Compendium.dms.items-dark-matter.Item.f1k0RthbVbMExX3I"};
    CONFIG.DND5E.tools.mechtools = {ability: "int", id:"Compendium.dms.items-dark-matter.Item.cqJLKlGxRxBIg4LJ"};
    CONFIG.DND5E.tools.shiptools = {ability: "int", id:"Compendium.dms.items-dark-matter.Item.IXOdACPYT3SEbUyM"};
}
